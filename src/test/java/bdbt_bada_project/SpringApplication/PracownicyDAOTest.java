...
class PracownicyDAOTest extends Object {
    ...
    @Test
    void save() {
        Pracownicy pracownik = new Pracownicy(0, "Igor", null, "Czunikin", new Date(1705436025805L), "12312312311", "M", "igor@gmail.com", "Opiekun", new Date(1705436025805L), 123123123, 797797797, 1, null, 1);
        dao.save(pracownik);
    }
