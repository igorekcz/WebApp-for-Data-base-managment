...
public class Pracownicy {
    ...
    public Pracownicy(int id_pracownika, String imie, String drugie_imie, String nazwisko, Date data_urodzenia, String pesel, String plec, String adres_email, String stanowisko, Date data_zatrudnienia, int nr_konta, int numer_telefonu, int id_oceanarium, String id_sklepu, int id_adresu, int id_uzytkownika) {
        super();
