    ...
    public class DashboardController {
        ...
        public String saveTicket(@ModelAttribute("konfigurator") BiletKonfigurator konfigurator){
            ...
            for(int i = 0; i < ilNorm; i++){
                biletyDAO.save(new Bilety(0, "Y", data_kupna, null, 100, 1));
            }
            for(int i = 0; i < ilUlg; i++){
                biletyDAO.save(new Bilety(0, "Y", data_kupna, null, 50, 1));
            }
            return "redirect:/main_user";
        }
        @RequestMapping("/main_employee")
        public String showEmployeePage(Model model){
            List<Wynagrodzenie> employeeWynagrodzenieList = wynagrodzenieDAO.listForEmployee(1);
        ...
        public String showEmployeeData(Model model){
            Pracownicy pracownik = pracownikDAO.get(1);
